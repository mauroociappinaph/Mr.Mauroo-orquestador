...
// ~/.config/gga.
//
// mr-mauroo-ai must write to the same location that GGA reads from; using
...
func BuildConfig(provider string) []byte {
	...
	b.WriteString("# Mr.Mauroo Guardian Angel Configuration\n")
	b.WriteString("# Generated by mr-mauroo-ai\n")
	b.WriteString("\n")
