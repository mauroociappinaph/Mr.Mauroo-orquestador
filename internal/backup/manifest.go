...
type Manifest struct {
	...
	// CreatedByVersion is the mr-mauroo-ai version that created this backup.
...
func backupRoot() (string, error) {
	...
	return filepath.Join(home, ".mr-mauroo-ai", "backups"), nil
}
...
// of the expected backup root (~/.mr-mauroo-ai/backups/). This prevents a tampered
