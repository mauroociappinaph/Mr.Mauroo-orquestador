...
const buildSmsContactList = (
  ...
  const normalizedRecipient = normalizeSmsContactName(recipient ?? "Colleague");
...
export function RetroOffice3D({
  ...
  gatewayUrl = "",
  gatewayToken = "",
  selectedAdapterType = "none",
  activeAdapterType = "none",
      ...
      if (item.type === "phone_booth") {
        ...
        setManualPhoneCallScenario(
          buildMockPhoneCallScenario({
            callee: "my contact",
            message: "This is a demo call from the Oficina 3D phone booth.",
            voiceAvailable:
              voiceRepliesLoaded &&
